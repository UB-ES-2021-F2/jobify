...
class TestWorkExperiencesResource(BaseTestCase):
    ...
    def test_successful_get(self):
        ...
        response = self.client.get('/api/work_experience/test')
        self.assertEquals(response.status_code, 200)

    def test_failed_get(self):
        self._add_data()

        response = self.client.get('/api/work_experience/test2')
        self.assertEquals(response.status_code, 404)
        self.assertDictEqual(response.json, {"work_experience": None})
    ...
    def test_access_denied_post(self):
        ...
        response = self.client.post('/api/work_experience/test2',
                                    headers={"Authorization": "Basic " + valid_credentials})
        self.assertEquals(response.status_code, 401)
        self.assertDictEqual(response.json, {'message': 'Access denied'})

    def test_job_name_space_post(self):
        self._add_data()
        ...
        response = self.client.post('/api/work_experience/test',
                                    headers={"Authorization": "Basic " + valid_credentials},
                                    json={'job_name': ' ',
                                          'description': 'a',
                                          'company': 'ub',
        ...
        self.assertDictEqual(response.json, {"message": "Job name cannot be blank"})
    ...
    def test_successful_post(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertDictEqual(response.json, {"work_experience": {'id': 2, 'username': 'test', 'job_name': 'a',
                                                                 'description': 'a', 'company': 'ub',
                                                                 'start_date': '2000-01',
